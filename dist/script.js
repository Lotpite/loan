...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    key: "init",
    value: function init() {
      var tag = document.createElement('script'); // создаем тег script
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    key: "moveBtnsToEnd",
    value: function moveBtnsToEnd() {
      var _this = this;

      this.slides.forEach(function (slide, i) {
        if (slide.tagName === 'BUTTON') {
          _this.container.appendChild(_this.slides[i]);
        }
      });
    }
  }, {
      ...
      this.prev.addEventListener('click', function () {
        for (var i = _this3.slides.length - 1; i > 0; i--) {
          if (_this3.slides[i].tagName !== "BUTTON") {
            ...
            console.log(_this3.slides[i].nextSibling);
